...
class ItemInfo2 extends StatefulWidget {
  const ItemInfo2({Key? key}) : super(key: key);

  @override
  State<ItemInfo2> createState() => _ItemInfo2State();
}

List<String> category = ['Ring', 'Necklace', 'Bracelet', 'Earring', 'Set'];

class _ItemInfo2State extends State<ItemInfo2> {
  String image_url = " ";
  ...
  void storeInDB(String name, String category, String price, String quantity,
      String description, String carat, String weight) async {
    // uploadImage();
  ...
  Future<void> GitemStoring({
    ...
    final url = Uri.parse('http://$ipAddress:5000/GitemStoring');
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        print('successful gitem storing ');
        Navigator.push(
          context,
